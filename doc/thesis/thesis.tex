...
\begin{itemize}
    ...
    \item The second guidance function evaluates a node with candidate set $S$ by calculating the sum of the $d$ nodes in $V \setminus S$ with the highest values for $d_S(u)$. \fxnote{GR: Was ist $d$ und $d_S$? Hier gibt es auch einen Nameclash.} This guidance function is designed to be more time-efficient than the previous one. 
\end{itemize}

\fxnote{GR: Came up to here!!!}
