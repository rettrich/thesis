...
Compared to the MQCP, only a few solution approaches have been proposed for the MDCP. The first algorithm is presented in \cite{Yu2006}, along with the first formal definition of the problem. 
