...
The final results on benchmark instances indicate that our approach can match the solution quality of the state-of-the-art methods for most instances with $|V| \leq 300$, but is not competitive yet for larger instances. 
