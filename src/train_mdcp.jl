...
function train_MDCP()
    ...
    local_search = LocalSearchBasedMH(
            ...
            timelimit, max_iter, next_improvement, record_swap_history, max_restarts, sparse_evaluation=settings[:sparse_evaluation], is_mdcp=true)
    ...
    baseline_local_search = LocalSearchBasedMH(
        ...
        timelimit, max_iter, next_improvement, record_swap_history=false, max_restarts, is_mdcp=true)
